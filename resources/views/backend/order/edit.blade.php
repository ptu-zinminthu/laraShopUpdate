...
@section('content')
    {{ Form::open(['route' => ['admin.orders.update',$order], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'create-role']) }}
 ...
 <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::select("product_id",$product_id,null,["class" =>"form-control","multiple"=>"multiple"]) !!}
  
                    </div><!--col-lg-10-->
 <div class="form-group">
                    <label class="col-lg-2 control-label">Order Amount</label>
                    <div class="col-lg-10">
                        <input type="text" name="order_amount" placeholder="Title" class="form-control" value="{{ $order->order_amount }}">
                    </div><!--col-lg-10-->
                </div><!--form control-->
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="order_address" placeholder="Image" class="form-control" value="{{ $order->order_address }}">
                    </div><!--col-lg-10-->
                </div><!--form control-->
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="text" name="order_phone" placeholder="Image" class="form-control" value="{{ $order->order_phone }}">
                    </div><!--col-lg-10-->
                </div><!--form control-->
  <div class="form-group">
